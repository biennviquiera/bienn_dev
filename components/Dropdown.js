export default function Dropdown(props) {
    return (
        <details className="container group pb-8 transition-transform">
            <summary style={{ listStyle: 'none'}} className="active:text-green-400 transition-colors list-none flex flex-wrap items-center pb-3 cursor-pointer hover:text-neutral-300">
